...
function loadClassDetails() {
    ...
    fetch("/data.json")
        ...
        data.map(function (item) {
            ...
            var load_option = "<select name=\"class-type\" id=\"\" aria-label=\"select classes\" class=\"input-div--control input-div--control_arrow\" ".concat(item.options ? "" : "disabled", ">\n                                ").concat(item.options ? item.options.map(function (data) { return "<option value=\"\">".concat(data, "</option>"); }) :
            ...
            var action_Section = item.action ?
                "<div class=\"card-footer\">\n                            <button class=\"btn\" aria-label=\"Preview\" ".concat(item.action.disablePreview ? "disabled" : "", ">\n                                <img src=\"assets/icons/preview.svg\" alt=\"\">\n                                <span hidden id=\"preview\" >this is button description </span>\n                            </button>\n                            <button class=\"btn\" aria-label=\"Manage Courses\" ").concat(item.action.disableCourseManager ? "disabled" : "", ">\n                                <img src=\"assets/icons/manage course.svg\" alt=\"\">\n                            </button>\n                            <button class=\"btn\" aria-label=\"Grad Submission\" ").concat(item.action.disableSubmission ? "disabled" : "", ">\n                                <img src=\"assets/icons/grade submissions.svg\" alt=\"\">\n                            </button>\n                            <button class=\"btn\" aria-label=\"Report\" ").concat(item.action.disableReport ? "disabled" : "", ">\n                                <img src=\"assets/icons/reports.svg\" alt=\"\">\n                            </button>\n                        </div>")
...
var mobile_menu = new MobileMenu(document.querySelector("#menu-toggle-btn"));
