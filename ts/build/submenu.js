export class SubMenu {
    constructor(element) {
        ...
        this.linkKeydownBinder = this.onLinkKeydown.bind(this);
        this.linkClickBinder = this.onMenuLinkClick.bind(this);
    ...
    openSubMenu(element) {
        ...
        if (element.getAttribute("aria-haspopup") === "true") {
            ...
            this.active_menu.forEach(el => {
                el.setAttribute("tabindex", "-1");
                el.addEventListener("keydown", this.linkKeydownBinder);
                el.addEventListener("click", this.linkClickBinder);
            });
            this.active_menu[0].setAttribute("tabindex", "0");
            this.active_index = -1;
    ...
    closeSubMenu() {
        if (this.menu_stack.length > 0) {
            ...
            this.active_menu.forEach(el => {
                el.setAttribute("tabindex", "-1");
                el.removeEventListener("keydown", this.linkKeydownBinder);
                el.removeEventListener("click", this.linkClickBinder);
            });
            // Set Global Variable
